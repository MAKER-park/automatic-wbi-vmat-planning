...
def main():
    ...
    df_all[cols].to_csv("case_dvh_evaluation_result_1stage.csv", index=False)

    with open("inference_result_3d_1stage.md", "w") as md_file:
    ...
    print(f"\nEvaluation complete. Report saved to 'inference_result_3d_1stage.md'.")
